...
CREATE TABLE "Flashcard" (
                             ...
                             "learning_step_no" INT4 NOT NULL,
...
-- CreateTable
CREATE TABLE "DailyCardReviews" (
                                    "id" INT4 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                    "card_id" INT4 NOT NULL,
                                    "deck_id" INT4 NOT NULL,
                                    "review_id" INT4 NOT NULL,
                                    "old_learning_step_no" INT4 NOT NULL,
                                    "old_is_new" BOOL NOT NULL,
                                    "old_due_date" INT4 NOT NULL,
                                    "is_review_complete" BOOL NOT NULL,

                                    CONSTRAINT "DailyCardReviews_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ReviewGenerated" (
                                   "id" INT4 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                   "date" INT8 NOT NULL,

                                   CONSTRAINT "ReviewGenerated_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Flashcard_is_new_idx" ON "Flashcard"("is_new");

-- CreateIndex
CREATE INDEX "Flashcard_learning_step_no_idx" ON "Flashcard"("learning_step_no");
...
-- CreateIndex
CREATE UNIQUE INDEX "ReviewGenerated_date_key" ON "ReviewGenerated"("date");
...
-- AddForeignKey
ALTER TABLE "DailyCardReviews" ADD CONSTRAINT "DailyCardReviews_card_id_fkey" FOREIGN KEY ("card_id") REFERENCES "Flashcard"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DailyCardReviews" ADD CONSTRAINT "DailyCardReviews_deck_id_fkey" FOREIGN KEY ("deck_id") REFERENCES "FlashcardDeck"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DailyCardReviews" ADD CONSTRAINT "DailyCardReviews_review_id_fkey" FOREIGN KEY ("review_id") REFERENCES "ReviewGenerated"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
/*
  ...
  - Changed the type of `old_due_date` on the `DailyCardReviews` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
-- AlterSequence
ALTER SEQUENCE "MultiChoiceAnswer_id_seq" MAXVALUE 9223372036854775807;
...
-- AlterTable
ALTER TABLE "DailyCardReviews" DROP COLUMN "old_due_date";
ALTER TABLE "DailyCardReviews" ADD COLUMN     "old_due_date" INT8 NOT NULL;
